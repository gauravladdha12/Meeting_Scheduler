...
static boolean cancel(HashMap<Integer,ArrayList<meeting>> hm,int cancel_id,int emp_id){
	...
	public static void main(String[] args) {
      ...
      /*  System.out.println(start_date+" ok");
        System.out.println(end_date+"  okk");
        System.out.println(start_convert+"  okk");
        System.out.println(end_convert+"  okk");*/
      // System.out.println(betweenDates(d_start,d_curr)+"  oh");
